"""
Custom Django Admin Site with enhanced dashboard.
"""
...
class YEAAdminSite(AdminSite):
    """
    Custom admin site with professional dashboard.
    """
    site_header = "YEA Poultry Management System"
    site_title = "YEA PMS Admin"
    index_title = "Dashboard"
    
    def index(self, request, extra_context=None):
        """
        Override the default admin index to show custom dashboard.
        """
        # Farm Statistics
        ...
        budget_data = ProcurementOrder.objects.aggregate(
            ...
            total_spent=Sum('total_cost_actual')
        )
        ...
        for payment in recent_payments:
            if payment.payment_date:
                recent_activities.append({
                    ...
                    'time': timezone.make_aware(timezone.datetime.combine(payment.payment_date, timezone.datetime.min.time()))
                })
...
# Create instance
yea_admin_site = YEAAdminSite(name='yeaadmin')
